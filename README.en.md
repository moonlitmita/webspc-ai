...
- `REDIS_SESSION_DB`: Redis session database index (optional, default 0 for session history)
- `REDIS_MODEL_DB`: Redis model database index (optional, default 1 for model configuration)
- `REDIS_MCP_DB`: Redis MCP database index (optional, default 2 for MCP configuration)
